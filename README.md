...
A complete web-based recipe sharing application where users can create accounts, share recipes, save favorites, and discover new dishes from the community.
...
### 1. Clone & Setup
```bash
git clone https://github.com/krispepper/482_cookup_phase_1.git
cd 482_cookup_phase_1
```

### 2. Install Dependencies
```bash
pip install flask mysql-connector-python python-dotenv cryptography bcrypt
```

### 3. Database Setup
```sql
-- Login to MySQL and run:
CREATE DATABASE fall2025_482cook;
USE fall2025_482cook;
...
#### ❤️ **Save Favorites**
1. While viewing any recipe, click the heart (❤️) button
2. Recipe is automatically saved to your favorites
3. Access your favorites through your profile page

#### 👤 **Your Profile Page**
1. Click "Profile" in the navigation menu
2. View three tabs:
   - **My Recipes:** All recipes you've posted
   - **Favorites:** Recipes you've liked from other users
   - **Activity:** Your recent activity on the platform

#### 📬 **Contact & Support**
1. Click "Contact" for support or feedback
...
5. **Favorite:** Click heart buttons on recipes you like
6. **Share:** Click "POST RECIPES" → Create your first recipe
7. **Profile:** Check "Profile" to see your recipes and favorites

### Regular User Flow:
1. **Login:** Use saved credentials
2. **Browse:** Check "RECIPES" for new community posts
3. **Interact:** Like recipes, view details
